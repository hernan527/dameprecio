...
const livePlans = useMemo(() => {
  ...
  return planesBase.map((plan: any) => {
    ...
    return {
      ...plan, // Mantenemos TODA la data original (clinicasData, plan_prestacion, etc)
      id: String(plan.id), // Forzamos ID como String para consistencia
      ...
      // Aseguramos que clinicsData exista para el modal
